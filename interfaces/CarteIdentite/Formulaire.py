...
#TSeparator1 = ttk.Separator(rootFIC)
#TSeparator1.place(relx=0.496, rely=0.153, relheight=0.668)
#TSeparator1.configure(orient="vertical")

menubar = tk.Menu(rootFIC, font="TkMenuFont", bg=_bgcolor, fg=_fgcolor)
rootFIC.configure(menu=menubar)

Entry1_3 = tk.Entry(rootFIC)
...
Entry1_1_2_1_1 = tk.Entry(rootFIC)
...
Label1_1_3_1_1 = tk.Label(rootFIC)
...
Entry1_1_2_1_1_1 = tk.Entry(rootFIC)
...
rootFIC.geometry("787x524+346+75")
rootFIC.minsize(120, 1)
rootFIC.maxsize(1370, 749)
rootFIC.resizable(1, 1)
rootFIC.title("Carte d'identité")
rootFIC.configure(background="#d9d9d9")
